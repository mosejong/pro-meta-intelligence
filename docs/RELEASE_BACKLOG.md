# Consolidated release backlog - 2026-09-15
...
| --- | --- | --- |
| P0 | Source freshness incident #58 | Provider error/backoff; last verified source August 31. Existing scheduler retries within policy. Keep incident open until fresh publication is served; successful cache reuse is not recovery. |
